...
\hline
JobPerf Not Missing & 2.67 & 5.6300 & 6.210 & 6.322539 & 7.0400 & 9.37 \\
JobPerf Missing & 2.97 & 4.1375 & 4.615 & 4.475937 & 4.8825 & 5.05 \\
\hline
\end{tabular}
\caption{JobSat Summaries - JobPerf Missing} \label{tab:ps}
%\end{table}
%\begin{table}[ht]
%\centering
\begin{tabular}{r|rrrrrr}
...
& Min. & 1st Qu. & Median & Mean & 3rd Qu. & Max. \\
\hline
JobPerf Not Missing & 2.75 & 5.5850 & 6.410 & 6.343402 & 7.1200 & 9.50 \\
JobPerf Missing & 3.57 & 4.5500 & 5.560 & 5.530000 & 6.0600 & 8.04 \\
\hline
\end{tabular}
\caption{WellBeing Missing Summaries} \label{tab:pw}
\end{table}
...
$$
\mathrm{E}(\mathtt{JobPerf}|\mathtt{WellBeing},\mathtt{JobSat},\mathtt{Age},\mathtt{Tenure},\mathtt{IQ}) =  \beta_0 + \beta_1 \mathtt{WellBeing} + \beta_2 \mathtt{JobSat} + \beta_3 \mathtt{Age} + \beta_4\mathtt{Tenrue} + \beta_5 \mathtt{IQ}
$$
...
Figure \ref{fig:pairs} shows the plots of each pair of covariates in our dataset. There does not appear to be any violation of a linear relationship between any of the 
\begin{figure}
\centering
